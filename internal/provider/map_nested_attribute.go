...
func (g GeneratorMapNestedAttribute) CustomTypeAndValue(name string, generated map[string][]byte) ([]byte, error) {
...
func (g GeneratorMapNestedAttribute) EffectiveTypeName() string {
...
func (g GeneratorMapNestedAttribute) WithResolvedTypeName(name string) schema.GeneratorAttribute {

...
func (g GeneratorListNestedBlock) CustomTypeAndValue(name string, generated map[string][]byte) ([]byte, error) {
...
func (g GeneratorListNestedBlock) EffectiveTypeName() string {

...
func (g GeneratorSetNestedAttribute) CustomTypeAndValue(name string, generated map[string][]byte) ([]byte, error) {
...
func (g GeneratorSetNestedAttribute) EffectiveTypeName() string {
...
func (g GeneratorSetNestedAttribute) WithResolvedTypeName(name string) schema.GeneratorAttribute {
